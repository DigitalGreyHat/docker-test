...
// Get Movie by id
app.MapGet("api/movies/{id}", (MovieService movieService, string id) =>
{
...
// Insert Movie
app.MapPost("/api/movies", (MovieService movieService, Movie movie) =>
{
...
// Update Movie
app.MapPut("/api/movies/{id}", (MovieService movieService, string id, Movie movie) =>
{
...
// Delete Movie
app.MapDelete("api/movies/{id}", (MovieService movieService, string id) =>
{
    var movie = movieService.Get(id);
    if(movie == null)
    {
